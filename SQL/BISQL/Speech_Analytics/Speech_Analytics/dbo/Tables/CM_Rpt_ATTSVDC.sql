CREATE TABLE [dbo].[CM_Rpt_ATTSVDC] (
    [EOM]              DATE           NULL,
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[CM_Rpt_ATTSVDC] TO [CORP\dmukherji]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[CM_Rpt_ATTSVDC] TO [CORP\tkumar]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[CM_Rpt_ATTSVDC] TO [CORP\musalunke]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[CM_Rpt_ATTSVDC] TO [CORP\pjain]
    AS [dbo];
