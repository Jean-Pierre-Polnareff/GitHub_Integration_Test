CREATE PROCEDURE [dbo].[usp_63_Rpt_SMS_IDL_Click] 
AS 
BEGIN 
...
DROP TABLE dbo.#IDLClickDataRaw_1
  SELECT a.RepExeDate
	  ...
	  ,a.Clientid
	  ,a.Session_Id
	  ,CASE WHEN A.Livevox_Result in('SMS MT Delivered','Operator Transfer') THEN b.LetterID ELSE NULL END LetterID
  ...
  WHERE b.SMSClickedDate>=a.RepExeDate
		AND A.Livevox_Result in('SMS MT Delivered','Operator Transfer')
  order by RepExeDate
