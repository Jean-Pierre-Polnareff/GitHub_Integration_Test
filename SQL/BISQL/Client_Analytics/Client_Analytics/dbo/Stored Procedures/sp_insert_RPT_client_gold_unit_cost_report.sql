...
/****** Object:  StoredProcedure [dbo].[sp_insert_RPT_client_gold_unit_cost_report]    Script Date: 11/8/2022 5:49:41 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[sp_insert_RPT_client_gold_unit_cost_report] 
...
SET @report_date = DATEADD(m, DATEDIFF(m, 0, @report_date), 0)
		...
		WHERE lcu.CLIENT_ID IN ('GOLD1', 'GOLD2', 'GOLD3', 'GOLD4', 'GOLD5', 'GOLD6', 'GOLD7')
