...
/****** Object:  StoredProcedure [dbo].[usp_Insert_RPT_POSTDATED_CHECKS_UNIQUE_ACCTS]    Script Date: 2/8/2023 9:31:47 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Object: dbo.usp_Insert_RPT_POSTDATED_CHECKS_UNIQUE_ACCTS
-- Create date: 06/16/2022
--
--  Description: Provides all CRM data for Postdated Checks unique Accounts
--
-- 	History
...
CREATE PROCEDURE [dbo].[usp_Insert_RPT_POSTDATED_CHECKS_UNIQUE_ACCTS] 
...
IF OBJECT_ID('Tempdb..#t') IS NOT NULL
    DROP TABLE #t;
     SELECT  SourceSystem = 'FACS'
           ...
           ,SUM(PD.PROMISE_PAYMENT) AS Promise_TTL
...
UNION
 ...
 SELECT     dcs.SourceSystem
           ...
           ,SUM(fcpd.PromiseDueAmt) AS Promise_TTL
           ,Neu_Owner_ID = NULL 
           ,fcpd.insertDate        
	       ,dcl.Commission                 
...
TRUNCATE TABLE CLIENT_ANALYTICS.[dbo].[RPT_POSTDATED_CHECKS_UNIQUE_ACCTS]
INSERT INTO CLIENT_ANALYTICS.[dbo].[RPT_POSTDATED_CHECKS_UNIQUE_ACCTS] SELECT * FROM #t 
----SELECT TOP 0 * INTO CLIENT_ANALYTICS.[dbo].[RPT_POSTDATED_CHECKS_UNIQUE_ACCTS]  FROM #t          
