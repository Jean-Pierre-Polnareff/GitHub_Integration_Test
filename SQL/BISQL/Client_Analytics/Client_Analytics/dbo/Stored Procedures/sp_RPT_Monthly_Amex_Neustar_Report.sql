...
---CREATE PROCEDURE  [dbo].[sp_RPT_Monthly_Amex_Neustar_Report]
CREATE PROCEDURE  [dbo].[sp_RPT_Monthly_Amex_Neustar_Report]

AS
/* 
Object: sp_RPT_Monthly_Amex_Neustar_Report

Description: Identify and insert Amex Neustar Report Monthly data into [CLIENT_ANALYTICS].[dbo].[Amex_Neustar_Summarized] and [CLIENT_ANALYTICS].[dbo].[Amex_Neustar_Active_Account_Phone_Inventory_Summarized]
...
-----DECLARE @start_dt datetime = '2021-09-01 00:00:00';
-----declare @end_dt datetime = '2021-09-30 23:59:59';	


-----------------------------------------------Date range for Monthly report.........................................................................
----------IF DAY(GETDATE()) = 1 AND DATENAME(dw,getdate()) <> 'Friday'
DECLARE @start_dt DATETIME =  DATEADD(month,  DATEDIFF(month, 0, GETDATE() ) , -31);                                 ----start of last month
DECLARE @end_dt datetime = DATEADD(SECOND, -1, DATEADD(month, DATEDIFF(month, 0, GETDATE()), 0));                    ----start of month minus 1 second
----------SELECT @start_dt;
----------SELECT @end_dt;
...
------DECLARE @start_dt datetime = '2021-07-01 00:00:00';
------declare @end_dt datetime = '2021-07-31 23:59:59';	
...
---- SELECT  COUNT(1) FROM #TMP_Scored_Attempt_Data WHERE CAST(Call_Connect_Time_CT AS TIME) > '23:06:00.000'
