...
GO
/****** Object:  StoredProcedure [dbo].[sp_RPT_Batch_Inv_Performance]    Script Date: 11/19/2025 7:14:15 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	DECLARE @in_dt	DATE = CAST(CAST(DATEADD(DD, -1, GETDATE())  AS DATE) AS DATETIME);
