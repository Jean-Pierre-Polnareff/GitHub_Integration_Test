...
CREATE PROCEDURE  [dbo].[sp_SFTP_Monthly_RPT_client_Amex_digital]
AS
BEGIN TRY
...
--FTP the zipped file
SET @vBCP = '\\dfw2-bisql-001\SSISFlatFileStage\ClientExport\AmexDigitalReport\WinSCP\WinSCP.com /ini=nul /command "open sftp://CCSINDIAPRD:Rt%ZgR#9Vf@fsgateway.aexp.com/ -hostkey=""ssh-rsa 2048 wRLgelobaUrzZ7GuNllGT3gLGDegumkurUmIZSRkRJU=""" "lcd \\dfw2-bisql-001\SSISFlatFileStage\ClientExport\AmexDigitalReport\Zipped" "cd /inbox" "put -resumesupport=off ' + @vZipped + '" "exit"';
EXEC xp_cmdshell @vBCP, no_output;
...
EXEC msdb.dbo.sp_send_dbmail
    ...
    @recipients = 'Tushar.P.Chauhan@aexp.com; Satyam.D.Singh@aexp.com', 
