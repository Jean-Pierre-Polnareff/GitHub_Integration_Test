...
/****** Object:  StoredProcedure [dbo].[sp_insert_fact_dial_excpt_compliance_check_facs]    Script Date: 9/29/2023 10:05:27 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[sp_insert_fact_dial_excpt_compliance_check_facs]
...
----into #facs_resrticted_calls
	  ...
	  FROM DW_MSTR_DM.dbo.vwca_CALL_HISTORY_FACT xyz (NOLOCK)
			  inner join 
