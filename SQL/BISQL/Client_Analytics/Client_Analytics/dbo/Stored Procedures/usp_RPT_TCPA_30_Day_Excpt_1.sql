...
CREATE PROCEDURE [dbo].[usp_RPT_TCPA_30_Day_Excpt]  
...
DROP TABLE IF EXISTS #fcc;
         SELECT fcc.keycustomercall
              ...
              , fcc.keyemployee
              , fcc.[KeyDialerResult]
              , fcc.[KeyDialerServiceType]
              , fcc.KeyDialerTransactionType
              , fcc.[Consumer_ID]
              , fcc.zip_scf
              , fcc.zip
              , fcc.[CallCenterName]
              ...
              , r.Dialer_Result
              , r.Dialer 
			into #fcc from DW_MSTR_DM.dbo.FactCustomerCall fcc  with (nolock) 
...
DROP TABLE IF EXISTS #temp_fcc_automated; 
	     SELECT fcc.[KeyCustomerCall]
	          ...
	          FROM #fcc fcc 
		      join DW_MSTR_DM.dbo.RadiusCall rc with (nolock) on rc.session_id = fcc.sessionid 
